...
class TrackSectorTest extends AnyFlatSpec:
  val curveSector: TrackSector = curve(0, 250, 100, 50, 1, 5)
  val straightSector: TrackSector = straight(0, 500, 300, 250, 1)
