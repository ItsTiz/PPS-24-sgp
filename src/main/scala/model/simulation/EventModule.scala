...
object EventModule:
   ...
   *
   * @param car The car that triggered the event
   * @param trackSector The track sector that the car entered
   * @param timestamp The simulation or system time when the event occurred
   */
   ...
   *
   * @param car The car that made the pit stop request
   * @param timestamp The simulation or system time when the event occurred
   */
